...
HD_PWD='S:/Dance Dance Revolution/Dance Dance Revolution.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodJSTK_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodJSTK_Demo.tcl -notrace
